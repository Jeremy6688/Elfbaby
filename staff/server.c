...
void process_login_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	if(nrow == 0){
		...
		get_system_time(msg.timeer);
		strcpy(msg.events,"User login succeeded...");
		printf("%s\t%s\t%s\n", msg.timeer,msg.name,msg.events);
		
		sprintf(sql,"insert into historyinfo values('%s','%s','%s');",msg.timeer,msg.name,msg.events);
...
void process_query_normal_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	if(nrow == 0){
		...
		get_system_time(msg.timeer);
		strcpy(msg.events,"User query succeeded...");
		printf("%s\t%s\t%s\n", msg.timeer,msg.name,msg.events);
...
void process_modify_normal_edge_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modify age succeeded...");
	printf("%s\t%s\t%s\n", msg.timeer,msg.name,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','%s','%s');",msg.timeer,msg.name,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_normal_phone_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modify phone succeeded...");
	printf("%s\t%s\t%s\n", msg.timeer,msg.name,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','%s','%s');",msg.timeer,msg.name,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_normal_passwd_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modify passwd succeeded...");
	printf("%s\t%s\t%s\n", msg.timeer,msg.name,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','%s','%s');",msg.timeer,msg.name,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_query_root_name_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	if(nrow == 0){
		...
		get_system_time(msg.timeer);
		strcpy(msg.events,"User successfully queried by name...");
		printf("%s\troot\t%s\n", msg.timeer,msg.events);
		sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
		if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
			printf("%s.\n",errmsg);
		}
		return;
...
void process_query_root_all_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	if(nrow == 0){
		...
		get_system_time(msg.timeer);
		strcpy(msg.events,"User query all information successfully...");
		printf("%s\troot\t%s\n", msg.timeer,msg.events);
		sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
		if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
			printf("%s.\n",errmsg);
...
void process_modify_root_name_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modified name successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_root_edge_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modified age successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_root_sex_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modified sex successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_root_department_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modified department successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_root_phone_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modified phone successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_modify_root_passwd_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User modified passwd successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_add_root_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	get_system_time(msg.timeer);
	strcpy(msg.events,"User added successfully...");
	printf("%s\troot\t%s\n", msg.timeer,msg.events);
	sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
	if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
		printf("%s.\n",errmsg);
...
void process_delete_root_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	if(strncmp(msg.jnumber,"1",1) != 0){
		get_system_time(msg.timeer);
		strcpy(msg.events,"User deleted successfully...");
		printf("%s\troot\t%s\n", msg.timeer,msg.events);
		sprintf(sql,"insert into historyinfo values('%s','root','%s');",msg.timeer,msg.events);
		if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
			printf("%s.\n",errmsg);
...
void process_query_history_root_request(int acceptfd,struct msg msg,sqlite3 *db)
{
	...
	if(nrow == 0){
		...
		get_system_time(msg.timeer);
		strcpy(msg.events,"User query history information succeeded...");
		printf("%s\t%s\t%s\n", msg.timeer,msg.name,msg.events);
		sprintf(sql,"insert into historyinfo values('%s','%s','%s');",msg.timeer,msg.name,msg.events);
		if(sqlite3_exec(db,sql,NULL,NULL,&errmsg) != SQLITE_OK){
			printf("%s.\n",errmsg);
